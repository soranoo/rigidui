    ...
    <div style={navFont.style} className="fixed top-1.5 left-0 w-screen h-16 bg-transparent z-50 flex gap-2 items-center justify-center">
      ...
      <div className="h-full sm:w-[80vw] bg-transparent backdrop-blur-lg rounded-lg flex items-center justify-center px-8 relative overflow-hidden shadow-light dark:shadow-none">
        ...
        <nav className="flex items-center lg:gap-6 relative z-10">
          ...
          <Link href="/docs" className="flex items-center lg:gap-3 gap-1.5 sm:px-4 px-3 py-2.5 rounded-lg hover:bg-emerald-50 dark:hover:bg-emerald-900/30 transition-all duration-200 group border border-transparent hover:border-emerald-100 dark:hover:border-emerald-800 hover:shadow-sm dark:hover:shadow-emerald-900/20">
      ...
      <div className="h-full sm:w-[8vw] w-[20vw] dark:bg-transparent backdrop-blur-lg rounded-lg flex items-center justify-center hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-xl dark:shadow-black/50 dark:hover:shadow-black/70 relative overflow-hidden group">
        ...
        <a href="https://github.com/fgrreloaded/rigidui" className="w-8 h-8 flex items-center justify-center group relative z-10">
